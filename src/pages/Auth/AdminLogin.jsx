        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label className="block text-xs font-mono text-red-400/80 uppercase tracking-wider">
                Admin Password
              </label>
              <Link to="/admin/forgot-password" className="text-[10px] text-red-500 hover:text-red-400 font-mono">
                Forgot Password?
              </Link>
            </div>
            <Input
